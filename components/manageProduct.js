    ...
    <>
      <div className="w-full felx justify-center">
        <div className="border shadow-xl pt-6 sm:rounded-lg">
          <p className="text-red-600 text-lg md:text-3xl w-full flex justify-center"><u><b>Manage Product</b></u></p>
                  ...
                  product.map((item, index) => {
                    return (
                      <tr key={index} className="bg-white border-b">
                        ...
                        <td className="px-6 py-4">
                          <Link href={"/editProduct/"+item._id}><button className="flex bg-blue-700 hover:bg-blue-800 text-white py-1 rounded-md px-2"><FiEdit className="mt-0.5 mr-1"/> Edit</button></Link>
                        </td>
                        <td className="px-6 py-4">
                          <button onClick={() => deleteProduct(item._id)} className="flex bg-red-700 hover:bg-red-800 text-white py-1 rounded-md px-2"><FaRegTrashAlt className="mt-0.5 mr-1"/> Delete</button>
                        </td>
                      </tr>
                    )
                  })
