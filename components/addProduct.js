    ...
    <>
      <div className="w-full felx justify-center">
        <div className="border shadow-xl p-6 sm:rounded-lg">
          <p className="text-red-600 text-lg md:text-3xl w-full flex justify-center"><u><b>Add Product</b></u></p>
          <div className="mb-4 mt-6">
            <label for="category" className="block text-grey-darker text-sm font-bold mb-2">Select Category</label>
            <select id="category" className="shadow bg-white border text-gray-darker rounded block w-full py-2 px-3" onChange={(e)=>setCategory(e.target.value)}>
          ...
          <div className="mb-4 mt-6 w-full flex justify-between">
            <div className="w-6/12">
              ...
              <select id="unit" className="shadow bg-white border text-gray-darker rounded block w-full py-2 px-3" onChange={(e)=>setUnit(e.target.value)}>
            ...
            <div className="w-6/12">
              ...
              <input className="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" id="price" type="number" placeholder="price" onChange={(e)=>setPrice(e.target.value)} />
            </div>
          </div>
          <div className="mb-4 mt-6">
            ...
            <input className="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" id="size" type="text" placeholder="size" onChange={(e)=>setSize(e.target.value)} />
          </div>
          <div className="mb-4 mt-6">
            <label className="block text-grey-darker text-sm font-bold mb-2" for="material">
              Material
            </label>
            <input className="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" id="material" type="text" placeholder="material" onChange={(e)=>setMaterial(e.target.value)} />
          </div>
          <div className="mb-4 mt-6">
            <label className="block text-grey-darker text-sm font-bold mb-2" for="Brand">
              Brand
            </label>
            <input className="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" id="Brand" type="text" placeholder="brand" onChange={(e)=>setBrand(e.target.value)} />
          </div>
          <div className="mb-4 mt-6">
            <label className="block text-grey-darker text-sm font-bold mb-2" for="Min Quantity">
              Min Quantity
            </label>
            <input className="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" id="Min Quantity" type="number" placeholder="min quantity" onChange={(e)=>setMinQty(e.target.value)} />
          </div>
          {others &&
          ...
          <button className="mb-2 p-2 text-white bg-blue-700 rounded-md hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 w-full" type="button" onClick={()=> NewProduct()} >
            Add Product
          </button>
          {error &&
